...
const Work = () => {
  return (
    ...
    <div className="bg-gray-900 border-black rounded-md w-92 h-72 absolute right-57 top-39"></div>
    <div className="bg-white border-black rounded-md w-72 h-42 absolute right-102 top-4"></div>
    <div className="bg-white border-black rounded-md w-82 h-52 absolute right-12 top-4"></div>
    <div className="bg-white border-black rounded-md w-72 h-42 absolute right-102 bottom-8"></div>
    <div className="bg-white border-black rounded-md w-82 h-52 absolute right-12 bottom-8"></div>
